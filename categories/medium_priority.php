<?php
    ...
    // Prepare the query to retrieve medium priority tasks for the current user
    $stmt = $connection->prepare("SELECT * FROM task WHERE user_id = ? AND priority = 'Medium' ORDER BY task_id ASC");
                ...
                <ul class="navbar-nav align-items-center justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="./low_priority.php">Low</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
