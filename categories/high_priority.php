<?php
    ...
    // Prepare the query to retrieve high priority tasks for the current user
    $stmt = $connection->prepare("SELECT * FROM task WHERE user_id = ? AND priority = 'High' ORDER BY task_id ASC");
